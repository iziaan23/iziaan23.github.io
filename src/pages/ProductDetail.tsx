...
const ProductDetail = () => {
  ...
  const productData: Record<string, any> = {
    "plain-labels": {
      ...
      description:
        "Our plain labels are manufactured using premium quality materials to ensure durability and superior performance across various applications. Available in thermal transfer and direct thermal options, these labels are designed to meet the demanding requirements of modern industries.",
      features: [
    ...
    "product-labels": {
      ...
      description:
        "Bring your brand to life with our custom product labels. We offer full-color printing, variable data capabilities, and premium finishing options to create labels that not only inform but also captivate your customers.",
      features: [
    ...
    "barcode-ribbons": {
      ...
      description:
        "Premium quality thermal transfer ribbons engineered for consistent, high-resolution printing. Our ribbons deliver exceptional barcode readability and durability across diverse printing environments.",
      features: [
    ...
    "stretch-film": {
      ...
      description:
        "High-performance stretch film designed for optimal load stability and protection. Our films offer superior puncture resistance and excellent cling properties for secure pallet wrapping.",
      features: [
    ...
    "bopp-tapes": {
      ...
      image: boppTapesImg,
      description:
        "Reliable BOPP adhesive tapes offering strong bonding performance for all your packaging needs. Available in various colors and with custom printing options for brand visibility.",
      features: [
    ...
    "printers": {
      ...
      image: printersImg,
      description:
        "Professional-grade label printers from industry-leading manufacturers. We offer comprehensive solutions including printer sales, installation, training, and ongoing technical support.",
      features: [
    ...
    "promotional-labels": {
      ...
      description:
        "Make your brand stand out with Square Pack's vibrant promotional stickers. Ideal for marketing campaigns, giveaways, and product packaging, our promotional labels are designed to attract attention and boost sales.",
      features: [
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  return (
                    <div
                      key={idx}
                      className="p-4 bg-white rounded-2xl border border-gray-200 text-center hover:shadow-lg transition-all duration-300"
                    >
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/contact" className="flex-1">
                  <Button
                    size="lg"
                    className="w-full bg-gradient-to-r from-navy to-blue-900 hover:from-navy/90 hover:to-blue-900/90 text-white font-bold text-lg py-7 shadow-xl hover:shadow-2xl transition-all duration-300"
                  >
                ...
                <a href="tel:+971504578900" className="flex-1">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full border-2 border-navy text-navy hover:bg-navy hover:text-white font-bold text-lg py-7 transition-all duration-300"
                  >
              ...
              <div className="p-6 bg-gradient-to-br from-gold/10 to-yellow-500/10 rounded-2xl border border-gold/20">
                <p className="text-sm text-gray-700 mb-2">
                  <span className="font-bold text-navy">Need assistance?</span>{" "}
        ...
        <div className="container mx-auto px-4">
          <Tabs defaultValue="features" className="max-w-6xl mx-auto">
            ...
            <TabsContent value="features" className="space-y-4 animate-fade-in">
              <h2 className="text-3xl font-bold text-navy mb-8 font-poppins">
                Key Features
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {product.features.map(
                  (feature: string, index: number) => (
                    <Card
                      key={index}
                      className="group hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-navy/20"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {product.specifications.map(
                  (spec: any, index: number) => (
                    <Card
                      key={index}
                      className="group hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-gold/30"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {product.applications.map(
                  (app: string, index: number) => (
                    <Card
                      key={index}
                      className="group hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-navy/20 bg-gradient-to-br from-white to-slate-50"
                    >
                      <CardContent className="p-6">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Get in touch with our team for custom quotes, bulk orders, or
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link to="/contact">
              <Button
                size="lg"
                className="bg-white text-navy hover:bg-gray-100 font-bold text-lg px-10 py-7 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
              >
                <Mail className="w-5 h-5 mr-2" />
                Contact Us
              </Button>
            ...
            <Link to="/products">
              <Button
                ...
                variant="outline"
                className="
                  border-2 border-white/80 text-white/95
                  backdrop-blur-sm bg-white/10
                  hover:bg-white hover:text-navy
                  font-bold text-lg px-10 py-7
