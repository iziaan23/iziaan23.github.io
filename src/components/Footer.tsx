      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="mt-4 p-3 bg-secondary/10 border-l-4 border-secondary rounded">
              <p className="text-secondary text-sm md:text-base font-bold italic">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 font-montserrat text-secondary">Contact Us</h3>
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <div className="text-white/70">
                  <a href="tel:+971504578900" className="hover:text-secondary transition-colors block">
                    +971 50 457 8900
                  </a>
                  <a href="tel:+971509929801" className="hover:text-secondary transition-colors block">
                    +971 50 992 9801
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div className="text-white/70">
                  <a href="mailto:mohammed@squarepack.net" className="hover:text-secondary transition-colors block">
                    mohammed@squarepack.net
                  </a>
                  <a href="mailto:sales@squarepack.net" className="hover:text-secondary transition-colors block">
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-xl font-bold mb-4 font-montserrat text-secondary">Follow Us</h3>
