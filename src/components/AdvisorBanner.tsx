...
export const AdvisorBanner = () => {
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] bg-gradient-to-r from-navy via-blue-900 to-indigo-900 py-3 md:py-4 shadow-lg">
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 md:gap-6 text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 md:gap-4 flex-wrap justify-center">
            ...
            <span className="text-white/40 hidden sm:inline">|</span>
            <a href="mailto:sales@squarepack.net" className="text-gold hover:text-amber-400 font-semibold transition-colors text-sm md:text-base whitespace-nowrap">
